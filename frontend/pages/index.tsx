    ...
    <PageTransition pageKey={pageKey} ref={ref}>
      ...
      <div id='home' className='h-full flex relative items-center -mt-5 md:mt-0 justfy-center bg-dark'>
          <div className="flex flex-col md:flex-row md:items-center gap-x-4 w-[70%] lg:w-[50%] mx-auto">
            <Image
              className="rounded-full lg:min-w-[200px] max-w-[150px] lg:max-w-[250px] border-2 border-yellow"
              src="/homero.jpg" 
              layout="responsive"
              width={0}
              height={0}
            ...
            <div className="flex flex-col text-light">
              <h3 className="font-semibold font-one text-3xl md:text-4xl lg:text-5xl">
                Homero Ochoa
              </h3>
              <p className="lg:text-lg font-light text-light/90 font-two ml-[1px]">
                Web Developer
              </p>
              <p className="mt-1 lg:mt-3 text-sm md:text-lg lg:text-xl font-two font-light text-light/[82%] ml-[2px]">
